...
const PRICE_API_URL: &str = "https://price.jup.ag/v6"; // Reference: https://quote-api.jup.ag/docs/static/index.html
...
pub async fn price(
    input_mint: Pubkey,
    output_mint: Pubkey,
) -> Result<HashMap<Pubkey, PriceInfo>> {
    ...
    price_map.insert(input_mint, price_info);
    Ok(price_map)
}
